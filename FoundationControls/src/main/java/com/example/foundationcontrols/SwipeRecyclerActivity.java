...
import com.example.foundationcontrols.adapter.LinearDynamicAdapter;
...
//结合SwipeRefreshLayout与RecyclerView：通过下拉刷新动态添加列表记录，从而省去一个控制按钮
@SuppressLint("DefaultLocale")
public class SwipeRecyclerActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, RecyclerExtras.OnItemClickListener, RecyclerExtras.OnItemLongClickListener, RecyclerExtras.OnItemDeleteClickListener {
    ...
    private final List<NewsInfo> mPublicList = NewsInfo.getDefaultList(); // 当前的公众号信息列表
    private final List<NewsInfo> mOriginList = NewsInfo.getDefaultList(); // 原始的公众号信息列表
