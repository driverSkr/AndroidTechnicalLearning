...
public class RecyclerGridAdapter extends RecyclerView.Adapter<RecyclerGridAdapter.ItemHolder>  implements
        OnItemClickListener, OnItemLongClickListener {
    private Context mContext; // 声明一个上下文对象
    private List<NewsInfo> mGoodsList;

    public RecyclerGridAdapter(Context mContext, List<NewsInfo> mGoodsList) {
